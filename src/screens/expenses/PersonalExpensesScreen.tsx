// File: src/screens/expenses/PersonalExpensesScreen.tsx — Detalle de compras personales.
...
import {
  useInfinitePersonalExpensesHistoryQuery,
...
export function PersonalExpensesScreen() {
  ...
  const summaryQuery = usePersonalExpensesSummaryQuery(dateFilters, enabled);
  const historyQuery = useInfinitePersonalExpensesHistoryQuery(
    listQueryParams,
    enabled
  );
  ...
  const subtitle = useMemo(() => {
    const base = "Compras registradas desde tus listas personales.";
  ...
  return (
    <ExpensesListView
      ...
      emptyText="Todavía no hay compras en tus listas personales."
    />
  );
}
